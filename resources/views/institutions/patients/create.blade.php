...
<br>
    ...
    <form id="formPatientsCreate" class="col s12" method="POST" action="{{route('patients.store')}}">
        
        @include('institutions.patients._form')

        <div class="box-button-dab">
            <button id="btnSubmit" class="waves-effect waves-light btn btn-create" id="btnSubmit" type="submit">
                Cadastrar
            </button>

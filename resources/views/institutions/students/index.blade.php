...
@section('content')
    ...
    <div class="container-main-top">
        ...
        <div class="box-main-right">
            <a class="waves-effect waves-light btn btn-create" href="{{route('students.create')}}">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="tooltipped" data-position="top" data-tooltip="Excluir" href="{{route('students.show', ['student' => $student, 'acao' =>'delete'])}}">
